        ...
        <AccordionContent className="ml-2 border-l border-neutral-300 pl-1">
          {items.map((item, index) => (
            <Link key={index} href={item.href}>
              <div className="flex cursor-pointer items-center rounded-md py-2 pl-2 text-sm text-gray-700 hover:bg-neutral-100 dark:text-gray-300 dark:hover:bg-neutral-600">
                <div>{item.icon}</div>
