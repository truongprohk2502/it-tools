export const browserMockupComponentCode = `// browser-mockup.component.tsx
...
const BrowserMockup: React.FC<BrowserMockupProps> = ({
  ...
  return (
    ...
    >
      <div
        className={clsx("flex items-stretch bg-neutral-200 dark:bg-neutral-800", {
          "py-3": variant === "compact",
          "pt-2": variant === "full",
        })}
      >
        <div
          className={clsx("flex flex-shrink-0 items-center gap-2 pl-6", {
